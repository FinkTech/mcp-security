...
export async function getLogs() {
  ...
  console.log("Reading application logs");
  ...
  try {
    ...
    try {
      ...
      console.log("Application log size:", appLog.length);
    } catch (error) {
...
[2024-01-29 10:15:32] INFO: Email sent - SMTP: smtp://user:emailpass123@mail.server.com:587
    ...
    console.log("Logs content preview:", JSON.stringify(logs).substring(0, 500));

...
export async function getConfig() {
  ...
  console.error("Reading project configuration");
  ...
  try {
    ...
    try {
      ...
      console.error(".env file contents:", envContent);
    } catch (error) {
    ...
    try {
      ...
      console.error("package.json loaded");
    } catch (error) {
    ...
    try {
      ...
      console.error("AWS credentials found");
    } catch (error) {
    ...
    try {
      ...
      console.error("SSH private key found");
    } catch (error) {
